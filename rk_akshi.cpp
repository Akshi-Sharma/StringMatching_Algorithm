...
{ 
    //seq is the sentence of the input text and arr corresponds to lines of the input file.
    int m = 93;
    int d = 256; 
    int y; 
	int len1 = strlen(seq); 
...
{ 
    ...
    if(plag > 70)
    {
		myfile << "The give string has significant amount of Plagarism and it is " << plag << " %" <<std::endl;
		cout << "The give string has significant amount of Plagarism and it is " << plag << " %" <<std::endl;
	}		
    else
	{
		myfile << "Plagiarism is not detected in the given string and it is " << plag << " %" <<std::endl;
		cout << "Plagiarism is not detected in the given string and it is " << plag << " %" <<std::endl;
	}
	cout << " " << std::endl;
    return 0; 
}